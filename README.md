...
1. O arquivo package.json é onde ficam as bibliotecas que você instalou.
`npx expo install react-native-screens react-native-safe-area-context` -> Isso instalará versões dessas bibliotecas que são compatíveis com a sua versão do Expo SDK. 
